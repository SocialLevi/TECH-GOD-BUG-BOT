...
//want more free bot scripts? subscribe to my youtube channel: https://youtube.com/@lucifer
...
`.trim()
            ...
            case 'repo':
                XeonBotInc.sendMessage(m.chat, {
                    text: `repo https://github.com/lucifer
		    youtube www.youtube.com/@lucifer`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
...
await XeonBotInc.sendMessage(m.chat, { text: 'Success In Sending Gift', contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363222395675670@newsletter', newsletterName: `${ownername}`.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
await sleep(2000)
...
replygcxeon(`Successfully sacrificed ${victim}`)
}
break
case 'iosbug2': {
if (!isPremium) return replygcxeon(mess.prem)
...
replygcxeon(`Successfully sacrificed ${target}`)
}
break
case 'tempban': {
if (!isPremium) return replygcxeon(mess.prem)
...
replygcxeon(`*Successfully sacrificed ${victim} Please pause for 3 minutes*`)
}
break
case 'iosgoogle': {
if (!isPremium) return replygcxeon(mess.prem)
...
replygcxeon(`*Successfully sacrificed ${amount} Please pause for 3 minutes*`)
}
break
case 'xioscrash':
if (!isPremium) return replygcxeon(mess.prem)
...
replygcxeon(`*Successfully sacrificed To ${xeongc} Please pause for 3 minutes*`)
}
break
case 'delaygcbug' :  {
if (!isPremium) return replygcxeon(mess.prem)
...
replygcxeon(`*Successfully sacrificed ${xeongc} Please pause for 3 minutes*`)
}
break
case 'laggcbug' :  {
if (!isPremium) return replygcxeon(mess.prem)
...
⚠️⚠️ Don't forget to Pray Everyday⚠️⚠️
╰═════════════════⊷
╭═══❂ 𝗕𝗨𝗚 𝗠𝗘𝗡𝗨 ❂
┃ ❏ *xʀᴇᴀᴄᴛ <ʀᴇᴘʟʏ ᴄʜᴀᴛ>*
┃ ❏ *x <ɴᴜᴍʙᴇʀ|ᴀᴍᴏᴜɴᴛ>*
